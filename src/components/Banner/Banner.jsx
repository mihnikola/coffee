          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Premium Blend Coffee typically refers to a high-quality mix of coffee beans, carefully selected and blended to create a rich, flavorful, and balanced cup of coffee
                </p>
